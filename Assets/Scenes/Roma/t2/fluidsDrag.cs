...
public class fluidsDrag : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    public Sprite fluid_tube;
    //default sprite 
    public Sprite fluid_bag;
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        GetComponent<Image>().sprite = fluid_tube;
        //changes size of the tool 
        GetComponent<RectTransform>().sizeDelta = new Vector2(350,300);
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (!slot)
        {
            GetComponent<Image>().sprite = fluid_bag;
